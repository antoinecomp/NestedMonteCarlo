...
//
public class MolecularEquivalence {
	
    static public void main(String[] args) throws Exception {
	if (args.length < 2) {
	    System.err.println("Usage: ");
	    System.err.println("  java MolecularEquivalence <reactant1> <reactant2>");
	    return;
	}

	// read mol 1
	Molecule a = MolImporter.importMol(args[0]);
	
	// read mol 2
	Molecule b = MolImporter.importMol(args[1]);

	boolean res;
	res = MolecularUtils.molecularSatisfiedBySomeChiralForm(a,b);
	System.out.println("Regular SML test result is "+res);

	res = MolecularUtils.molecularSatisfiedBySomeChiralForm(b,a); // b is desired product, a is generated product 
	System.out.println("Forward reaction result is "+res);
	
	res = MolecularUtils.molecularEquivalence(a, b); // b is desired product, a is generated product 
	System.out.println("Molecular equivalence result is "+res);
	}
